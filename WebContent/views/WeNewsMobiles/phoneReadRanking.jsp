...
<div class="searchAdvertise">
    <a href="#"><img class="search-imgresp" src="<%=basePath%>images/bg_read.png"></a>
...
$(function() {
	...
	function() {
		if (getScrollTop() + getWindowHeight() == getScrollHeight() || $("#_page_").val()==1) {
			...
			$.getJSON("<%=basePath%>/Ranking/getphoneNoticeReadRankingJson",
			{
...
function getRankDOM(array){
	...
	if ((array.level) == 1) {
        tmp +=  '<div class="searchRank" style="">' +
                ...
                '<span limit="8" class="rank_school"> ' + array.author+'  '+((array.school==undefined)?"":array.school) + '</span>' +
                '<div class="rank_weimi"><img src="<%=path%>/images/read.png"></div>' +
