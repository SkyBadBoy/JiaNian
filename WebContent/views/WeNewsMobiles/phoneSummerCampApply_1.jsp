...
<div id="main " class="bg_26a052">
    <div class="main bg_fffeee color_26a052" style="margin-bottom: 50px;">
        ...
        <p class=""><img class="main_p_img" src="<%=basePath%>images/school/qnxzb1.jpg?v=1" data-preview-src="" data-preview-group="1"></p>
        ...
        <!--七、关注微信公众号-->
        <p class="main_title">六、关注微信公众号</p>
...
<div class="qnxzb-popup qnxzb-popup-in" id="qnxzb-div" >
    <div class="qnxzb-popup-inner">
        ...
        <div class="qnxzb-p-detail" id="Surplus">剩余金额：<span>1880</span>-<span>1000</span>-<span>1000</span>+<span>400</span>=<span>400</span></div>
...
function checkpay(){
	var str="剩余金额：${Competition.stringParamA}";
   ...
   str=str+"="+num;
	$("#Surplus").html(str);
	if('<%= user.getPhone()%>'=='null' || '<%= user.getPhone()%>'=='' || '<%= user.getParentName() %>'=='' || '<%= user.getParentName()%>'=='null'){
