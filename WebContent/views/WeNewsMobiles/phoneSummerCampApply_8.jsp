...
<html>
<head>
     <title>少年中国说——首届中小学生口语表达能力展演大赛</title>
    <meta charset="utf-8">
...
<div id="main " class="bk_fff">
    <div class="main bk_fff color_000" style="margin-bottom: 50px;">
        <h2 class="main_h2 bg_d74b68" style="">少年中国说——首届中小学生口语表达能力展演大赛</h2>
      
        <p class="img_p"><img class="main_p_img img_response"  src="<%=basePath%>images/school/long-1.jpg"  data-preview-src="" data-preview-group="1"></p>
        <p class="img_p"><img class="main_p_img img_response"    src="<%=basePath%>images/school/long-2.jpg"  data-preview-src="" data-preview-group="1"></p>
        <p class="img_p"><img class="main_p_img"  src="<%=basePath%>images/school/long-3.jpg?v=1"  data-preview-src="" data-preview-group="1"></p>
        <p class="img_p"><img class="main_p_img"  src="<%=basePath%>images/school/long-4.jpg"  data-preview-src="" data-preview-group="1"></p>
...
<input type="hidden" id="dataContent" name="dataContent" value="少年中国说——首届中小学生口语表达能力展演大赛，下载微新闻社APP马上参加" />
