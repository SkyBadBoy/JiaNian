...
<html>
<head>
     <title>新浪微新闻社夏令营之“我是全能小主播”</title>
    <meta charset="utf-8">
...
<div class="banner">
    <img src="<%=basePath %>images/school/banner5.jpg?v=1.0.1" id="imgId"/>
</div>
<div id="main " class="bg_26a052">
    <div class="main bg_fffeee color_26a052" style="margin-bottom: 50px;">
        <h2 class="main_h2 bg_26a052">新浪微新闻社夏令营之“我是全能小主播”</h2>
        <p class="act_title "> 8天励志营活动方案：</p>
        <!--一、相关信息-->
         <!--一、相关信息-->
        <p class="main_title">一、相关信息：</p>
        <p class="main_p_detail">活动费用：3280元/人 </p>
        <p class="main_p_detail">行程天数：8天7夜 </p>
        ...
        <p class=""><img class="main_p_img" src="<%=basePath%>images/school/qnxzb1.jpg" data-preview-src="" data-preview-group="1"></p>
        <p class="main_p_detail">共招6期，每期时间8天，每期限招300人（按年龄段进行分班，每班15人-20人）。</p>
        <!--行程安排-->
       ...
       <p class="main_title">行程安排</p>
        ...
        <p class=""><img class="main_p_img" src="<%=basePath%>images/school/qnxzb5.png?v=1" data-preview-src="" data-preview-group="1"></p>
        <!--六、Sixth Day（第六天）-->
        <p class="main_title">六、Sixth Day（第六天）</p>
        <p class=""><img class="main_p_img" src="<%=basePath%>images/school/qnxzb6.png?v=1" data-preview-src="" data-preview-group="1"></p>
        <!--七、Seventh Day（第七天）-->
        <p class="main_title">七、Seventh Day（第七天）</p>
        <p class=""><img class="main_p_img" src="<%=basePath%>images/school/qnxzb7.png?v=1" data-preview-src="" data-preview-group="1"></p>
        <!--八、eightth Day（第八天）-->
        <p class="main_title">八、eightth Day（第八天）</p>
        ...
        <!--<div class="table_body">-->
            <!--<table class="re" id="re">-->
                ...
                <!--<tr style="display: table-row;">-->
                    <!--<td style="background: linear-gradient(rgb(249, 249, 249), rgb(241, 241, 241)); text-align: center;">-->
                        <!--1-->
                    <!--</td>-->
                    <!--<td></td>-->
                    <!--<td></td>-->
                    <!--<td style="width: 50px; margin: 0px auto; vertical-align: middle;"></td>-->
                <!--</tr>-->
                <!--<tr style="display: table-row;">-->
                    <!--<td style="background: linear-gradient(rgb(249, 249, 249), rgb(241, 241, 241)); text-align: center;">-->
                        <!--2-->
        ...
        <p class="main_p_detail">1、营地食宿、训管、服装、道具、资料等费用：3280元/人。</p>
        ...
        <!--六、优惠规则-->
        <p class="main_title color_e98751">六、优惠规则：</p>
        <p class="main_p_detail">1、预付600元可免400元(相当于付600等于付1000元)。</p>
        <p class="main_p_detail">2、微信邀请 自己分享的链接报名,报名的时候给予一定的返利 每邀请一人返利100元 最多返利400元。(非通过微信端报名的不支持返利)</p>
        <p class="main_p_detail">3、分享朋友圈 分享到朋友圈可以返利100元。(非通过微信端报名的不支持返利)</p>
        <p class="main_p_detail">优惠规则最终解释权归杭州校播科技有限公司所有</p>
        <!--七、关注微信公众号-->
        <p class="main_title">七、关注微信公众号</p>
        <p class="main_p2">微信号：xiaobofabu </p>
        <p class="main_p2">详询：</p>
        <p class="main_p2">杨老师  <a href="tel:15355930038">15355930038</a></p>
        <p class="main_p2">柴老师  <a href="tel:18612828361">18612828361</a></p>
...
<div class="qnxzb_jg bg_fdfaf3"  >
    <div class="text-jg "><h2><strong class="color_e98751"><span>预付：</span>￥<span style="color: #e98751;">${Competition.stringParamB }</span></strong>&nbsp;
     <c:if test="${WeMoney!=null}">
      <del>原价：￥3280</del>
...
<div id="affirm_join" class="affirm">
    <div class="affirm_up">
        <div class="img_box lf">
            <img src="<%=basePath%>images/school/22.jpg" alt="">
        </div>
        <div class="affirm_jieshao lf">
            <p class="affirm_introduce">新浪微新闻社夏令营之“我是全能小主播”</p>
            <p class="total"><del class="zk_btn">折前：￥3280.00</del>预付金额&nbsp;￥<span total="${Competition.stringParamB}">${Competition.stringParamB }</span></p>
        </div>
    </div>
    <div class="affirm_down">
    	...
    	<div class="norms_qc" style="    padding-top: 10px;">
            <p>夏令营期次</p>
	         ...
	         <span data-value="5" value="5" class="norms_qc_a ">第五期</span>
	         <span data-value="6" value="6" class="norms_qc_a ">第六期</span>
        </div>
        <div class="norms" style="    padding-top: 10px;">
            <p>选修课(可选，四选一)：每天下午14：00-15:30上选修课</p>
            <c:forEach var="Prod" items="${OptionalCourse}">
	            <span data-value="${Prod.memo}" value="${Prod.PKID}" class="norms_a ">￥${Prod.memo}&nbsp;${Prod.name}</span>
            </c:forEach>
        </div>
       <div class="norms_yj" style="    padding-top: 10px;">
            <p>可选栏目(可选)</p>
	         <span data-value="200" value="1" class="norms_yj_a ">￥200&nbsp;影集</span>
        </div>

     <c:if test="${MyWeMoney >=1000 }">
         <div class="norms_wm">
         <p class="qnxzb_p">拥有微米${MyWeMoney }，最高抵扣5000，将抵扣￥500元</p>
            <c:if test="${MyWeMoney >=1000 }">
           		 <span data-value="1000.00" class="norms_wm_a " name="wm">1000微米</span>
            </c:if>
             <c:if test="${MyWeMoney >=2000 }">
           		 <span data-value="2000.00" class="norms_wm_a " name="wm">2000微米</span>
            </c:if>
             <c:if test="${MyWeMoney >=3000 }">
            	<span data-value="3000.00" class="norms_wm_a " name="wm">3000微米</span>
            </c:if>
            <c:if test="${MyWeMoney >=4000 }">
           		 <span data-value="4000.00" class="norms_wm_a " name="wm">4000微米</span>
            </c:if>
            <c:if test="${MyWeMoney >=5000 }">
            	<span data-value="5000.00" class="norms_wm_a " name="wm">5000微米</span>
            </c:if>
          </div>
       </c:if>
...
<div class="qnxzb-popup qnxzb-popup-in" id="qnxzb-div" >
    <div class="qnxzb-popup-inner">
        ...
        <div class="qnxzb-p-detail" id="Surplus">剩余金额：<span>3280</span>-<span>1000</span>-<span>1000</span>+<span>400</span>=<span>400</span></div>
        ...
        <div class="mui-card">
            <ul class="mui-table-view">
                <li class="mui-table-view-cell mui-collapse mui-active">
                    <a class="mui-navigate-right" href="#">返利规则（点击查看）：</a>
                    <div class="mui-collapse-content">
                        <!--p class="qnxzb_detail">1、微米折扣 1:10 最高抵扣5000微米。</p-->
                        <p class="qnxzb_detail">1、微信邀请 自己分享的链接报名,报名的时候给予一定的返利 每邀请一人返利100元 最多返利400元。(非通过微信端报名的不支持返利)</p>
                        <p class="qnxzb_detail">2、分享朋友圈 分享到朋友圈可以返利100元。(非通过微信端报名的不支持返利)</p>
                        <p class="qnxzb_detail">3、预付600元可免400元(相当于付600等于付1000元)。</p>
                        <p class="qnxzb_detail">优惠规则最终解释权归杭州校播科技有限公司所有</p>
                    </div>
                </li>
            </ul>
        </div>
...
<script src="<%=basePath%>js/school/globe.js?v=4"></script>
...
function checkpay(){
	...
	var str="剩余金额：${Competition.stringParamA}-1000";
	var num=${Competition.stringParamA}-1000;
   ...
   str=str+"="+num;
	...
	if(<%= user.getID()==0 %>){
		window.top.location ="<%=basePath%>Students/phoneRegister?returnURL="+encodeURIComponent(window.location.href);
		webToast("正在跳转,请提交报名信息","bottom",1800);
	...
	c.b='${buid}';
	c.c= cousr+'-'+photo+'-'+qc;
	var attach= "<%= WXUtil.getWeChatAttach(request, SmBaseGlobal.PayUse.MatchPay.getid(), String.valueOf(user.getID()), String.valueOf(ac.getID()) ) %>";
