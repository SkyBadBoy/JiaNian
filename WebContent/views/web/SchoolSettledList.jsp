								...
								<thead>
									<tr>
										...
										<!--  <th data-width="25%" data-field="notices.title">新闻标题</th>  -->
										  <th data-width="20%" data-field="wcid.company">学校名字</th>  
									  <th data-width="20%" data-field="createTime">时间</th> 
										<!-- <th data-width="20%" data-field="students.area.Name">学校地区</th> -->
									</tr>
								</thead>
							</table>
					</div>
	...
	<script type="text/javascript">
		...
		!function(e, t, o) {
			...
			function() {
				DataTable.bootstrapTable({
					...
					url : "<%=path%>/Students/getSchoolSettledList?sina=<%= SmBaseUtil.Random() %>",
					search : !0, 
					pagination : !0,
					showRefresh : !0,
					showToggle : !0,
					showColumns : !0,
					formatSearch:function(){return "查找学校"},
		...
		function getQueryList(searchText){
			if(searchText==null || searchText==undefined){
				searchText=$("* input[placeholder='查找学生']").val();
			}
			//+encodeURI(encodeURI(searchText)),
			DataTable.bootstrapTable("refresh", {
				url : "<%=path%>/Students/getSchoolSettledList?sina=<%= SmBaseUtil.Random() %>&SName="+encodeURI(encodeURI(searchText))
