						...
						<table id="exampleTableEvents" data-height="<%=SmBaseGlobal.ScreenHeight %>"
							...
							<thead>
								<tr>
									...
									<th data-field="stringParamJ">性别</th>
									<th data-field="stringParamI">英文名</th>
									<th data-field="teacher">监护人</th>
									<th data-field="phone">手机号</th>
									<th data-field="intParamB">年龄</th>
									<th data-field="createTime">报名申请时间</th>
									<th data-field="stringParamA">学校</th>
									<th data-field="stringParamB">班级</th>
									<th data-field="stringParamC">城市</th>
									<th  data-width="60" data-field="stringParamD">自我介绍</th>
									<th  data-width="60" data-field="stringParamE">兴趣爱好</th>
									<th  data-width="60"  data-height="60" data-field="stringParamF">领袖的素质?</th>
									<th  data-width="60" data-field="stringParamG">新西兰的认识?</th>
									<th data-width="60" data-field="stringParamH">国际关系的认识?</th>
								</tr>
							</thead>
						</table>
					</div>
	...
	var myPay=$("#mypayTable");
		!function(e, t, o) {
			...
			function() {
				DataTable.bootstrapTable({
					url : "<%=path%>/Competition/getCompetitionList?type=2&sina=<%= SmBaseUtil.Random() %>",
					search : !0,
					...
					showToggle : !0,
					showColumns : !0,
					formatSearch:function(){return "请输入姓名";},
					striped : !0, //是否显示行间隔色
		...
		function getQueryList(searchText){
			...
			DataTable.bootstrapTable("refresh", {
				url : "${path}/Competition/getCompetitionList?type=2&sina=<%= SmBaseUtil.Random() %>&searchText="+ searchText +"&&"+params
			});
		}
