...
function(a) {
    ...
    m = function() {
        ...
        this.insertVideo = function(b, c) {
            e(b);
            l=c.substr(c.indexOf("vid")+4);
            var videoid=parseInt(Math.random()*10000+1)
            if (l.length>0) {
                var q = g[2];
                d = a("<div id='"+ videoid +"'>").attr("width", "640").attr("height", "360");
                	tvp.$.getScript(($("#Path")?$("#Path").val():$("#basePath").val())+'js/tvp.player.setting.js?t='+ (+new Date()), function(){
    ...
    t = function() {
        ...
        g = function(a, b) {
            var d = function() {
                return '<div class="note-image-dialog modal" aria-hidden="false"><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true" tabindex="-1">&times;</button><h4>' + a.image.insert + '</h4></div><div class="modal-body"><div class="row-fluid"><div id="ImageListContainer"></div><input class="note-image-url form-control span12" id="note-image-url" type="hidden" /></div></div><div class="modal-footer"><button href="#" id="refer" onclick="getImageList()" class="btn btn-primary" >' + a.image.refer + '</button><button href="#" onclick="openUploadImageHtml()" id="selectFromFiles" style="display:none;" class="btn btn-primary" >' + a.image.selectFromFiles + '</button><button href="#" class="btn btn-primary note-image-btn disabled" disabled="disabled">' + a.image.insert + "</button></div></div></div></div>"
            },
            e = function() {
