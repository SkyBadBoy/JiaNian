jQuery(function () {
    ...
    function i() {
        var e, a = "";
        "ready" === k ? a = "选中" + m + "张图片，共" + WebUploader.formatSize(h) + "。" : "confirm" === k ? (e = n.getStats(), e.uploadFailNum && (a = "成功上传" + e.successNum + "张照片，" + e.uploadFailNum + '张照片上传失败，<a class="retry" href="#">重新上传</a>')) : (e = n.getStats(), a = "共" + m + "张（" + WebUploader.formatSize(h) + "），已上传" + e.successNum + "张", e.uploadFailNum && (a += "，失败" + e.uploadFailNum + "张")), p.html(a)
    }
    ...
    n = WebUploader.create({
        ...
        disableGlobalDnd: !0,
        chunked: !0,
        server: $("#picurl").val()+"?"+$("#uploadPicParam").val(),
        fileNumLimit: 9,
        ...
        if(window.getIframeVal){
        	getIframeVal(response);
        }
