 ...
 * Licensed under the MIT license */
    function (t, e, n, i) {
        ...
        var wt = s(function (t, e, n) {
            ...
            return wt(t, e, !0)
        }, "merge", "Use `assign`."), Tt = 1, kt = /mobile|tablet|ip(ad|hone|od)|android/i, xt = "ontouchstart"in t, _t = T(t, "PointerEvent") !== i, Ct = xt && kt.test(navigator.userAgent), bt = "touch", Mt = "pen", Et = "mouse", Dt = "kinect", Ot = 25, Pt = 1, At = 2, It = 4, Ht = 8, St = 1, Yt = 2, Vt = 4, Nt = 8, Ft = 16, qt = Yt | Vt, zt = Nt | Ft, Lt = qt | zt, Rt = ["x", "y"], jt = ["clientX", "clientY"];
        _.prototype = {
            handler: function () {
            }, init: function () {
